...
- Last updated: 2026-05-16 (post T-I.62 — Phase 22 events-card mini-arc complete; operator-read complement to the emission surface)
- Repository: `RachEma-ux/MyNewAp1Claude`
- Branch: `main`
- Latest merged PR: `#1243` (T-I.62 — latest-rows table on events card) at `da346ad5`
- Latest milestone PR: `#1243` (closes events-card mini-arc — operators answer how many / which kinds / which emitters / what specifically on one screen)
