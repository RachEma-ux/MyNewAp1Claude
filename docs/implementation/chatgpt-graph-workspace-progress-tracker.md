...
- Last updated: 2026-05-16 (post T-I.65 — Phase 22 events-card kind-filter mini-arc complete; drill-in extension on the operator-dashboard mini-arc shape)
- Repository: `RachEma-ux/MyNewAp1Claude`
- Branch: `main`
- Latest merged PR: `#1247` (T-I.65 — clickable kind cells on the by-kind rollup table) at `43103be7`
- Latest milestone PR: `#1247` (closes kind-filter mini-arc — operators can focus → drill-in → clear on the events card via dropdown OR rollup-click)
