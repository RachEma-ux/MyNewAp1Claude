...
9. **15-δ / 16-δ further UI surfaces** — PR-V1-44 (#795) shipped the first focused component (SavedViewVersionHistoryPanel). Follow-ups: route/page that embeds the panel, restore-version action, attachment-library + template-management UI panels, attachment-quota dashboard surface.
