...
export async function detectHardware(): Promise<HardwareProfile> {
  ...
  const profile: Partial<HardwareProfile> = {
    ...
    cudaVersion: (gpuInfo as Record<string, unknown>).cudaVersion as string | undefined,
    rocmVersion: (gpuInfo as Record<string, unknown>).rocmVersion as string | undefined,
    ...cpuInfo,
    ...memoryInfo,
    ...platformInfo,
  };
