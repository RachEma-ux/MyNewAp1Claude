      ...
      z
        .object({
          ...
          jobKind: z
            ...
            .optional(),
          jobKindLike: z.string().min(1).max(100).optional(),
    ...
    .input(
      z
        .object({
          ...
          recentJobsCreatedSince: z.coerce.date().optional(),
          recentAttemptsGte: z.number().int().min(0).max(1000).optional(),
          errorClass: z
            .union([
              z.string().min(1).max(200),
          ...
          recentErrorEventsUserId: z
            .union([
              z.number().int().positive(),
              z.array(z.number().int().positive()).max(50),
            ])
            .optional(),
          recentErrorEventsSourceId: z
            .union([
              z.string().min(1).max(200),
              z.array(z.string().min(1).max(200)).max(50),
            ])
