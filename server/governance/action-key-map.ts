...
export const ACTION_KEY_MAP: Record<string, string> = {
  ...
  "agentStudio.providerBindings.list": "agentStudio.providerBindings.list",
  "agentStudio.providerBindings.create": "agentStudio.providerBindings.create",
  "agentStudio.providerBindings.update": "agentStudio.providerBindings.update",
