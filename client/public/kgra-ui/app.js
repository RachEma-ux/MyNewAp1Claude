...
output: GenerationResult</pre>
      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <pre>curl -X POST /api/kgra-proxy/pipelines/ \\
  ...
  "strategy": "single"
      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <pre>curl -X POST /api/kgra-proxy/pipelines/local_ollama_rag/invoke \\
  -H "Content-Type: application/json" \\
...

{
  ...
  fallback_threshold: 0.6</pre>
      ...
      <div class="card" style="margin-bottom:16px;">
        ...
        <pre># Submit async
curl -X POST /api/kgra-proxy/pipelines/my_pipeline/invoke_async \\
  -H "Content-Type: application/json" \\
