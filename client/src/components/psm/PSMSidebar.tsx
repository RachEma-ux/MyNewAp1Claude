/**
 * PSM Sidebar — Simple IBM Shell sidebar (cloned from PRMSidebar)
 */
...
interface Props {
  active: PSMView;
  onNavigate: (key: PSMView) => void;
  collapsed: boolean;
  onToggle: () => void;
}

export default function PSMSidebar({ active, onNavigate, collapsed, onToggle }: Props) {
  return (
    <div
      className={cn(
      ...
      >
        {!collapsed && (
          <div className="flex items-center gap-2 min-w-0">
            <Compass className="h-3.5 w-3.5 shrink-0 text-teal-500" />
