  ...
  const navEntries: NavEntry[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Templates", path: `${base}/projects/project-templates` },
        { label: "Examples", path: `${base}/projects/examples` },
        ...
        { label: "Portfolio", path: `${base}/projects/portfolio` },
        { label: "Reporting", path: `${base}/projects/reporting` },
        { label: "Time Report", path: `${base}/projects/time-report` },
        { label: "Cost Report", path: `${base}/projects/cost-report` },
        { label: "Budgets", path: `${base}/projects/budgets` },
        { label: "Project Home", path: `${base}/projects/project-home` },
        { label: "Git Links", path: `${base}/projects/git-references` },
