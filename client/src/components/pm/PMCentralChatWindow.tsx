/**
 * PMCentralChatWindow — "PM Chat" floating multi-AI chat window
 *
 * Module-level chat for PM Central. Mounted in PMCentralShell so it
 * stays visible across all PM Central pages. Intercom-style FAB at
 * bottom-right; expands into a chat panel with round-table AI
 * participants from the catalog.
 *
...
interface PMCentralChatWindowProps {
...
export function PMCentralChatWindow({ catalogImports }: PMCentralChatWindowProps) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      toast.error(`PM Chat error: ${err.message}`);
    } finally {
