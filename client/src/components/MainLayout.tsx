...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        { label: "Overview", icon: <LayoutDashboard className="w-4 h-4" />, href: "/digital-hq/overview" },
        { label: "Team", icon: <Users className="w-4 h-4" />, href: "/digital-hq/team" },
        { label: "Projects", icon: <FolderOpen className="w-4 h-4" />, href: "/digital-hq/projects" },
        { label: "Operations", icon: <Activity className="w-4 h-4" />, href: "/digital-hq/operations" },
        { label: "Incidents", icon: <AlertTriangle className="w-4 h-4" />, href: "/digital-hq/incidents" },
        { label: "Changes", icon: <GitPullRequest className="w-4 h-4" />, href: "/digital-hq/changes" },
        { label: "Monitoring", icon: <BarChart3 className="w-4 h-4" />, href: "/digital-hq/monitoring" },
        { label: "Activity", icon: <Clock className="w-4 h-4" />, href: "/digital-hq/activity" },
      ]
    },
    {
      ...
      children: [
        { label: "Dashboard", icon: <LayoutDashboard className="w-4 h-4" />, href: "/governance-center/dashboard" },
        { label: "Gate Coverage", icon: <Shield className="w-4 h-4" />, href: "/governance-center/gate-coverage" },
        { label: "Risk Matrix", icon: <AlertTriangle className="w-4 h-4" />, href: "/governance-center/risk-matrix" },
        { label: "Audit Trail", icon: <FileText className="w-4 h-4" />, href: "/governance-center/audit-trail" },
        { label: "Access Control", icon: <Key className="w-4 h-4" />, href: "/governance-center/rbac" },
        { label: "Policy Engine", icon: <Settings className="w-4 h-4" />, href: "/governance-center/policy-engine" },
        { label: "Evidence Vault", icon: <Package className="w-4 h-4" />, href: "/governance-center/evidence-vault" },
        { label: "Hardening", icon: <Lock className="w-4 h-4" />, href: "/governance-center/hardening" },
      ]
    },
