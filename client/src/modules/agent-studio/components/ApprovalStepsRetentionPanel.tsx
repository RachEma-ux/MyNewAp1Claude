// ApprovalStepsRetentionPanel — operator UI for the
// `ags_approval_steps` lifecycle-aware retention cron.
//
// Sister panel to PublishRequestsRetentionPanel + NotePromotionsRetentionPanel.
// Parent-lifecycle-aware: a step can't be retention-eligible
// independently of its parent publish-request. The step's effective
// terminal moment is MAX(step.terminal_at, parent.terminal_at).
//
// Backing cron: env AGS_APPROVAL_STEPS_RETENTION_CRON_EXPR /
// AGS_APPROVAL_STEPS_RETENTION_DAYS. Default daily 19:00 UTC, 90-day
// window.
//
...
export function ApprovalStepsRetentionPanel() {
  const statusQuery =
...
export default ApprovalStepsRetentionPanel;
