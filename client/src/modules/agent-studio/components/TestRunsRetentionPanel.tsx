// TestRunsRetentionPanel — operator UI for the
// `ags_test_runs` retention cron (cascades `ags_test_run_results`).
//
// Three-cell status grid + terminal-status checkboxes + agentId +
// suiteId filters. Mirrors SimulationRunsRetentionPanel shape; the
// extra suiteId filter is test-runs-specific.
//
// Backing cron: env AGS_TEST_RUNS_RETENTION_CRON_EXPR /
// AGS_TEST_RUNS_RETENTION_DAYS. Default daily 11:00 UTC.
//
...
export function TestRunsRetentionPanel() {
...
export default TestRunsRetentionPanel;
