/**
 * OM Settings — Tabbed settings page (General + Wizard)
 */
    ...
    <div className="space-y-4 p-4">
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="wizard" className="space-y-4 mt-4">
          <Card>
            <CardHeader><CardTitle className="text-sm">Wizard Settings</CardTitle></CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">OM Wizard configuration will be managed here.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
