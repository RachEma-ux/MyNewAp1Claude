...
export function createDefaultWizardData(): WizardData {
  return {
    ...
    stakeholders: [],
    pmConfirmed: false, decisionModel: "", riskTier: "medium",
    dataTier: "internal", complianceTags: [],
    ...
    definitionOfDone: "", reviewWorkflow: "",
    teamMembers: [],
    reportingCadence: "", stakeholderUpdateFrequency: "",
    channels: [], escalationPath: "",
    riskRegister: [],
    vendors: [],
    engagementStrategy: "", communicationMapping: "", changeReadiness: "",
  };
}
